...
export const TRIP_DATA = {
  ...
  todos: [
    { item: "Kyoto accommodation (8-10 Jul)", urgency: "urgent", when: "This week", cost: "~$280-360", notes: "2 nights. July peak season — Gion fills fast. Gion / Higashiyama area recommended. Leah is sourcing this one." },
    { item: "Hiroshima accommodation (10-12 Jul)", urgency: "urgent", when: "This week", cost: "~$250-350", notes: "2 nights. Walking distance to Peace Park strongly recommended. Andrew investigating — top picks: RIHGA Royal Hotel Hiroshima, ANA Crowne Plaza Hiroshima." },
