  ...
  },
  {
    ...
    days: [
      { day: "Day 7 cont.", date: "Wed 8 Jul", title: "Arrive Kyoto", items: [
        { time: "Afternoon", activity: "Arrive Kyoto — check in", type: "locked", note: "Ref RXS539474 · Check-in 15:00-00:00 · No after-hours check-in, front desk greets on arrival · Bring passports — photocopy required at check-in" },
      ...
      { day: "Day 8", date: "Thu 9 Jul", title: "Fushimi Inari + Arashiyama Bike Tour", items: [
        { time: "5:00am", activity: "Fushimi Inari — before the crowds (gates glow at dawn)", type: "agreed" },
        { time: "8:00am", activity: "Breakfast at Nohga Hotel — included", type: "locked" },
        { time: "Morning", activity: "Head to Saga-Arashiyama Station for the bike tour", type: "todo", note: "Leah booked — confirm meeting point arrival timing ahead of 13:00 start" },
        { time: "1:00pm", activity: "Afternoon Kyoto Bike Tour: Bamboo Forest, Monkeys & Hidden Spots", type: "locked", note: "~4 hrs guided · Monkey Park Iwatayama, Bamboo Forest Street, Tenryu-ji Temple garden, Togetsukyo Bridge · English guide · Meeting point: Saga-Arashiyama Station · Confirm final payment is through — ticket was showing 'available after final payment'" },
      ...
      { day: "Day 9", date: "Fri 10 Jul", title: "Depart for Hiroshima", items: [
        ...
        { time: "Before 12:00", activity: "Check out — Nohga Hotel Kiyomizu Kyoto", type: "todo", note: "Paid via Expedia — city tax + optional extras only" },
  ...
  },
  {
    ...
    days: [
      ...
      { day: "Day 10", date: "Sat 11 Jul", title: "Peace Museum + Miyajima + Mount Misen hike", items: [
        { time: "Morning", activity: "Peace Memorial Museum", type: "locked", note: "Allow 2-2.5 hrs — emotionally heavy, don't rush" },
        { time: "Late morning", activity: "Tram to ferry terminal, ferry to Miyajima (~30 min)", type: "agreed" },
        { time: "Midday", activity: "Itsukushima Shrine + floating torii gate, deer", type: "agreed" },
        { time: "Lunch", activity: "Quick lunch on Miyajima before the hike — momiji manju or street food", type: "suggested" },
        { time: "Afternoon", activity: "Hike Mount Misen — Daisho-in or Momijidani trail up, ropeway down (or reverse)", type: "agreed", note: "~2-3 hrs return depending on trail and pace · Reaches highest peak on the island" },
  ...
  },
  {
    ...
    days: [
      { day: "Day 11 cont.", date: "Sun 12 Jul", title: "Arrive Osaka", items: [
        { time: "Afternoon", activity: "Arrive Osaka — check in", type: "locked", note: "Ref 6091.751.149 · PIN 7186 · Check-in 15:00-00:00 · Approx arrival flagged 15:00-16:00" },
      ...
      { day: "Day 13", date: "Tue 14 Jul", title: "Depart Osaka to Philippines", items: [
        { time: "Morning", activity: "Check out by 11:00 — Shizutetsu Hotel Prezio", type: "todo", note: "No prepayment — pay ¥20,028 at property on checkout" },
...
export const TRIP_DATA = {
  ...
  bookings: [
    ...
    { ref: "Viator-Kyoto", date: "9 Jul 13:00", detail: "Afternoon Kyoto Bike Tour — Bamboo Forest, Monkeys & Hidden Spots · 2 adults · 4hrs · Booked by Leah", cost: "TBC — confirm payment", status: "locked" },
  ],
  todos: [
    { item: "Confirm Kyoto bike tour final payment went through", urgency: "medium", when: "Before 9 Jul", cost: "—", notes: "App showed 'Your ticket: Available after final payment' — check with Leah this has cleared so the e-ticket is ready before the 13:00 meeting time at Saga-Arashiyama Station." },
  ...
  gear: [
    ...
    { item: "Arashiyama Bike Tour (Kyoto)", status: "done", cost: "TBC", notes: "Booked by Leah · 9 Jul 13:00 · Bamboo Forest, Monkey Park Iwatayama, Tenryu-ji garden, Togetsukyo Bridge · Confirm final payment cleared" },
  ...
  budget: [
    ...
    { item: "Arashiyama Bike Tour (Kyoto, booked by Leah)", cost: "TBC", status: "est" },
