...
export const TRIP_DATA = {
  ...
  todos: [
    { item: "Kyoto accommodation (8-10 Jul)", urgency: "urgent", when: "Today/tomorrow — 2 days to departure", cost: "~$280-360", notes: "2 nights. July peak season — Gion fills fast. Gion / Higashiyama area recommended. Leah is sourcing this one — last accommodation gap, no more runway." },
    { item: "Send Henann bed type request email", urgency: "urgent", when: "Today — 2 days to departure", cost: "—", notes: "Send to manila.hrb@henann.com (Boracay booking inbox, not Iloilo). Draft ready — request double/queen bed instead of twins. Ref QA62J4ANR." },
    { item: "Aldi merino tops + underwear", urgency: "urgent", when: "Today/tomorrow — 2 days to departure", cost: "~$80-100", notes: "3-4 tees each + boxers. Stock confirmed. Sizing runs small." },
    { item: "Email Henann re: early check-in", urgency: "medium", when: "Can send alongside bed type request now, or closer to 15 Jul", cost: "—", notes: "Arriving ~9am 15 Jul, check-in from 15:00. Ref QA62J4ANR." },
  ...
  gear: [
    ...
    { item: "Aldi Merino tops + underwear", status: "todo", cost: "~$80-100", notes: "3-4 tees each + boxers. Stock confirmed. Sizing runs small. 2 days to departure — do this today/tomorrow." },
  ...
  budget: [
    ...
    { item: "Aldi merino clothing", cost: "~$80-100", status: "todo" },
