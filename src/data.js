...
export const TRIP_DATA = {
  ...
  todos: [
    { item: "Kyoto accommodation (8-10 Jul)", urgency: "urgent", when: "This week", cost: "~$280-360", notes: "2 nights. July peak season — Gion fills fast. Gion / Higashiyama area recommended. Leah is sourcing this one — last accommodation gap." },
    { item: "Send Henann bed type request email", urgency: "high", when: "Today", cost: "—", notes: "Draft ready — request double/queen bed instead of twins. Ref QA62J4ANR." },
