...
export const TRIP_DATA = {
  ...
  todos: [
    { item: "Henann bed type request — sent", urgency: "low", when: "Done", cost: "—", notes: "Email sent to manila.hrb@henann.com requesting double/queen instead of twins. Ref QA62J4ANR. Awaiting reply." },
    { item: "Email Henann re: early check-in", urgency: "medium", when: "Can combine with bed type follow-up, or closer to 15 Jul", cost: "—", notes: "Arriving ~9am 15 Jul, check-in from 15:00. Ref QA62J4ANR." },
    { item: "Comfortable hiking shoes for Mount Misen", urgency: "medium", when: "Before departure", cost: "—", notes: "Hoka Clifton 10 and NB 1080s should be fine for the trail — both road-to-trail capable. No need to buy dedicated hiking boots." },
    ...
    { item: "Wear in Hoka Clifton 10s", urgency: "low", when: "Before 2 Jul", cost: "—", notes: "Don't arrive in Japan with new shoes. Wear them now — also relevant for the Mount Misen hike." },
  ],
  gear: [
    ...
    { item: "Hoka Clifton 10 (Andrew) — Size 9.5", status: "done", cost: "~$220", notes: "Rebel Sport Maitland · Wear in before 2 Jul · Also suitable for Mount Misen hike" },
    { item: "Leah's NB 1080s", status: "done", cost: "Owned", notes: "Confirmed suitable — no replacement needed, also fine for Mount Misen" },
